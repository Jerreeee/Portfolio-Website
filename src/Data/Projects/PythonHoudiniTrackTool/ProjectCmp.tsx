...
`}
        ...
        <Box>
          <H4>Json vs Multiparameter block</H4>
...
`}
      ...
      <Box mt={4}>
        ...
        <H5>Active handle user interface</H5>
        ...
        <H5>Changing the active handle</H5>
        ...
        <H5>Updating other parameters</H5>
        ...
        <H5>Defining spare parameters</H5>
        ...
        <H5>Adding and deleting spare parameters</H5>
        ...
        <H5>Changing the curve position</H5>
        ...
        <H5>Adding and deleting handles</H5>
      ...
      {/* --------------------------------------------------------- */}
      <Box mt={4}>
        <H2>Creating a python viewer state</H2>
        ...
        {/* --------------------------------------------------------- */}
        <H5>Selecting handles in the viewport</H5>
        ...
        {/* --------------------------------------------------------- */}
        <H5>Cycling the active parameter</H5>
        ...
        {/* --------------------------------------------------------- */}
        <H5>Updating parameter values</H5>
        ...
        {/* --------------------------------------------------------- */}
        <H5 id="creating-a-hud-info-panel">Creating a HUD info panel</H5>
        ...
        {/* --------------------------------------------------------- */}
        <H4 id="integration-into-unreal-engine">
          Integration into Unreal Engine
        </H4>
        ...
        {/* REFLECTION                                                */}
        {/* --------------------------------------------------------- */}
        <H2 id="prototyping">Reflection</H2>

        <H4 id="so-how-did-the-tool-compare-when-built-with-and-without-python-viewer-states-how-did-i-experience-using-python-in-houdini">
        ...
        <H4 id="is-using-houdini-engine-in-combination-with-houdini-session-sync-a-benefit-to-the-game-asset-creation-pipeline">
