...
import { ProjectCard } from '@/Themes/Default/Components/ProjectCard';
...
export function ProjectPage() {
  ...
  const cmpTheme = theme.components.projectPage;

  return (
    <>
      <main className="w-full sm:w-[70%] mx-auto p-4">
        <h1 className="text-3xl text-center font-bold"
        style={{ color: cmpTheme.foreground }}
        >
          Featured
        </h1>
      ...
      <a
        ...
        style={{
          backgroundColor: cmpTheme.foreground,
          color: cmpTheme.background,
        }}
      >
